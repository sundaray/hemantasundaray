...
This is because the `motion{:.comp}` component needs access to DOM nodes to perform animations; however, Server Components in Next.js run on the server and don't have access to the DOM.
