...
In Terraform, we use a language called **HashiCorp Configuration Language** (HCL) to write code. This code is stored in files with the `.tf` extension, commonly referred to as **Terraform configuration files**.
